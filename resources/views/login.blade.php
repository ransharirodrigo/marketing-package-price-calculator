...
<div class="container-fluid ">
    <div class="row vh-100 d-flex align-items-center justify-content-center py-5">
        <div class="login-container bg-white rounded-4 shadow-lg overflow-hidden col-12 col-sm-8 col-lg-6 col-xl-4">
            <div class="common-gradient text-center p-3 mt-3">
            ...
            <form id="login_form" method="post" action="{{ route('admin.login') }}">
                ...
                <div class="p-4 p-md-3">
                    <div class="mb-4">
                        ...
                        <input type="email" class="form-control common-form-control" value="admin@gmail.com" id="email" name="email" required placeholder="{{ __("main.enter")." ".__("main.your")." ".__("main.email") }}" value="">
                    </div>

                    <div class="mb-4">
                        <label for="password" class="common-form-label">{{ __("main.password")}}</label>
                        <input type="password" class="form-control common-form-control" value="admin" id="password" name="password" required placeholder="{{ __("main.enter")." ".__("main.your")." ".__("main.password") }}" value="">
                    </div>
                    ...
                    <p class="common-text text-center mt-4">© 2025 Digital Marketing Agency</p>
                     <div>
                        <p class="common-text text-center m-0">Email: admin@gmail.com</p>
                        <p class="common-text text-center m-0">Password: admin</p>
                    </div>
                </div>
            </form>
        </div>
